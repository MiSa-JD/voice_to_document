...
.PHONY: install runtime-dirs check-format lint typecheck api-schema api-schema-check test-unit test-frontend test-integration test-e2e test compose-smoke model-smoke transcription-smoke model-eval
